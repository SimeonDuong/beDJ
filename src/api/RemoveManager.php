 ...
 * Description: Takes a USER_id and removes it from a specified HOST_id
 */
...
if($userprivilege['user_privilege'] <= 10){
	mysql_query("UPDATE UserHostMap SET remove_time = NOW() WHERE USER_id = '".$input['TARGET_id']."' AND HOST_id = '".$input['HOST_id']."'")
